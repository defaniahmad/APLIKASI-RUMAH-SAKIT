 ...
 */
public class C_Obat extends javax.swing.JDialog {
     ...
     */
    public C_Obat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(refresh, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 240, 87, 37));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(C_Obat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                C_Obat dialog = new C_Obat(new javax.swing.JFrame(), true);
    ...
    private void fungsi_simpan_data() {
        try {
            Connection koneksi = (Connection) DriverManager.getConnection("jdbc:mysql://localhost/rumahsakit","root","");
            koneksi.createStatement().executeUpdate("INSERT INTO obat VALUES('"+e_kd_obat.getText()+"'"
